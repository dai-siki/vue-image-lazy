...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lazy = __webpack_require__(301);

	var _lazy2 = _interopRequireDefault(_lazy);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_vue2.default.use(_lazy2.default, {
	...
	new _vue2.default({
		el: '#app',
		data: {
			imgs: ['imgs/1.jpg', 'imgs/2.jpg', 'imgs/3.jpg', 'imgs/4.jpg', 'imgs/5.jpg', 'imgs/6.jpg', 'imgs/7.jpg', 'imgs/8.jpg', 'imgs/9.png', 'imgs/10.jpg', 'imgs/11.jpg', 'imgs/12.jpg', 'imgs/13.jpg', 'imgs/14.jpg', 'imgs/15.jpg']
		}
	});
	...
	exports.default = {
		install: function install(Vue) {
			...
			function imgLoad(el, src, handleScroll) {
				var sts = el.getAttribute('lazyStatus'); //1代表加载中
